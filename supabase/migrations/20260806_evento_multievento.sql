-- Multi-evento: "Evento Santiago" y "Evento Brasil" comparten la tabla de
-- inscripciones; la columna `evento` distingue a cuál se inscribió la persona.
...
-- persona puede inscribirse en Santiago y en Brasil).
alter table public.evento_inscripciones
