    ...
    modulos: [
      {
        ...
        quien: "Todo el equipo (edición: jefaturas)",
        resumen: "Meta neta y de cantidad por vendedor y mes. Aquí se asigna el canal de cada uno.",
        funciones: [
          "Avance neto y bruto, progreso, cumplimiento y brecha por vendedor.",
          "Tarjetas de proyección, top cumplimiento y ritmo del mes.",
          "El CANAL asignado aquí (Terreno, Tienda, Mercado Público, Web, Freelance…) define qué tablas de comisión se aplican.",
        ],
      },
      {
        id: "metas-canal",
        titulo: "Resumen canales",
        icono: "SlidersHorizontal",
        ruta: "/metas-canal",
        acceso: { tipo: "modulo", key: "resumen_canales" },
        quien: "Jefaturas y administración",
        resumen: "El cumplimiento agregado por canal de venta.",
        funciones: ["Meta, avance, cumplimiento y brecha por canal, con apoyo por vendedor."],
      },
      {
        id: "comisiones",
        titulo: "Comisiones",
