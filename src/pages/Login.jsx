...
export default function Login() {
  ...
  // Iniciar sesión con Google solicitando además permisos de Gmail (send +
  // modify). Cuando Supabase nos devuelve la sesión, el listener global
  // GoogleAuthSync captura el refresh_token y lo guarda en correo_cuentas
  // para que el buzón quede conectado automáticamente.
  async function handleGoogleLogin() {
    ...
    const { error: err } = await supabase.auth.signInWithOAuth({
      ...
      options: {
        ...
        redirectTo: `${window.location.origin}/listar`,
      },
    });
    if (err) {
    ...
    // Si todo va bien, signInWithOAuth redirige a Google — no hace falta
    // hacer nada más aquí.
  }
        ...
        <div className="login-form-inner">
          ...
          <form onSubmit={handleLogin} className="login-stack">
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 12, margin: "6px 0" }}>
              ...
              <span style={{ fontSize: 11.5, color: "#94a3b8", fontWeight: 600, letterSpacing: ".05em", textTransform: "uppercase" }}>O</span>
              <div style={{ flex: 1, height: 1, background: "#e2e8f0" }} />
            </div>
            ...
            <button
              ...
              style={{
                ...
                fontWeight: 600,
                fontSize: 14,
                cursor: loading || loadingGoogle ? "default" : "pointer",
                display: "flex",
                alignItems: "center",
            ...
            >
              {loadingGoogle ? (
                <svg className="login-spinner" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#0f172a" strokeWidth="2.5">
                  <path d="M21 12a9 9 0 1 1-6.219-8.56"/>
                </svg>
              ) : (
            ...
            <div style={{ fontSize: 11.5, color: "#64748b", textAlign: "center", lineHeight: 1.5, marginTop: -2 }}>
              Al usar Google iniciás sesión y tu Gmail queda conectado automáticamente para enviar correos desde la plataforma.
            </div>
          </form>
