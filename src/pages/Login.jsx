...
export default function Login() {
  ...
  async function loginConGoogle() {
    setError("");
    setLoading(true);
    // Pedimos scope gmail.modify (incluye send + read) + offline access para
    // recibir refresh_token. gmail.modify es necesario para leer las respuestas
    // de los correos en el módulo de Comunicaciones de la cotización.
    // 'consent' fuerza la pantalla de autorización al menos la primera vez
    // (necesario para que Google entregue refresh_token).
    ...
    if (err) {
      setLoading(false);
      setError(`No se pudo iniciar el login con Google: ${err.message}`);
    }
    // Si no hay error, signInWithOAuth ya redirigió al usuario a Google.
  }
        ...
        <div className="login-form-inner">
          ...
          <form onSubmit={handleLogin} className="login-stack">
            ...
            <div style={{
              ...
              margin: "8px 0", color: "var(--text-muted)", fontSize: "12px",
            }}>
